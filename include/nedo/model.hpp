...
#include <vector>
namespace nedo {
struct ModelConfig { uint32_t vocab=0,dim=0,layers=0,heads=0,kv_heads=0,head_dim=0,ffn=0,context=0,sliding=0; float rms_eps=1e-5f,rope_theta=10000.f; };
...
private:
    struct Layer { const TensorInfo *an{},*q{},*k{},*v{},*o{},*fn{},*gate{},*up{},*down{},*route{}; };
    GgufFile gguf_; SurfaceTokenizer tok_; ModelConfig cfg_; SchemaReport schema_; const TensorInfo* emb_{}; const TensorInfo* out_norm_{}; const TensorInfo* out_{}; std::vector<Layer> blocks_;
