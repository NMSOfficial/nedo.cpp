...
PYBIND11_MODULE(_core,m){
    ...
    py::class_<nedo::GenerationConfig>(m,"GenerationConfig")
        .def(py::init<>())
        .def_readwrite("max_new_tokens",&nedo::GenerationConfig::max_new_tokens)
        .def_readwrite("temperature",&nedo::GenerationConfig::temperature)
        .def_readwrite("top_p",&nedo::GenerationConfig::top_p)
        .def_readwrite("top_k",&nedo::GenerationConfig::top_k)
        .def_readwrite("repetition_penalty",&nedo::GenerationConfig::repetition_penalty)
        .def_readwrite("no_repeat_ngram_size",&nedo::GenerationConfig::no_repeat_ngram_size)
        .def_readwrite("seed",&nedo::GenerationConfig::seed)
        .def_readwrite("add_bos",&nedo::GenerationConfig::add_bos);
